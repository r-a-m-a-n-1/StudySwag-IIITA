...
const ProblemSolving = () => {
  // Generate 50 video items. Replace thumbnail, videoUrl, and description as needed.
  const videoData = Array.from({ length: 50 }, (_, index) => ({
    id: index + 1,
    title: `Problem Solving Video ${index + 1}`,
    thumbnail: "https://img.youtube.com/vi/dQw4w9WgXcQ/hqdefault.jpg",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "Strategies for effective problem solving with programming.",
  }));
  ...
  return (
    <div className="bg-black text-white w-full min-h-screen p-8">
      <h1 className="text-4xl font-bold text-center mb-8">
        Problem Solving with Programming - Video Lectures
      </h1>
