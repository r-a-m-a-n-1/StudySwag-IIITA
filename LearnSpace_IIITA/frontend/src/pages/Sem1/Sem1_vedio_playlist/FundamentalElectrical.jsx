...
const FundamentalPhysics = () => {
  // Generate 50 video items. Adjust thumbnail, videoUrl, and description as needed.
  const videoData = Array.from({ length: 50 }, (_, index) => ({
    id: index + 1,
    title: `Fundamental Electrical & Electronics Video ${index + 1}`,
    thumbnail: "https://img.youtube.com/vi/dQw4w9WgXcQ/hqdefault.jpg",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "Learn the basics of circuit analysis and electronics components.",
  }));
  ...
  return (
    <div className="bg-black text-white w-full min-h-screen p-8">
      <h1 className="text-4xl font-bold text-center mb-8">
        Fundamental Electrical &amp; Electronics Engineering - Video Lectures
      </h1>
...
export default FundamentalPhysics;
