...
const Sem4_it_VedioPlaylist = () => {
  return (
    <div className="fixed inset-0 bg-black text-white overflow-auto">
      {/* Custom Header */}
      <div className="pt-24 pb-8 max-w-screen-xl mx-auto px-4 flex flex-col items-center">
        <h1 className="text-4xl font-bold mb-8">Semester 4 IT - Subject Playlists</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          >
            ...
            />
            <h2 className="text-xl font-bold text-center px-2">Computer Graphics &amp; Visulization (CGV)</h2>
          </Link>
          ...
          >
            <img
              ...
              className="w-16 h-16 mb-4 animate-bounce"
            />
            <h2 className="text-xl font-bold text-center px-2">DataBase Managment System (DBMS)</h2>
          </Link>
          ...
          >
            ...
            />
            <h2 className="text-xl font-bold text-center px-2">
              Principal of Programming Language (PPL)
            </h2>
          </Link>
...
export default Sem4_it_VedioPlaylist;
