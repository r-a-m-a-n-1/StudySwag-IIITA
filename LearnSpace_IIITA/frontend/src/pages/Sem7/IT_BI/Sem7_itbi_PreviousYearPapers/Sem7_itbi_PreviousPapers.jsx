...
const Sem7_itbi_PreviousYearPaper = () => {
  return (
    <div className="fixed inset-0 bg-black text-white overflow-auto">
      <div className="pt-24 pb-8 max-w-screen-xl mx-auto px-4 flex flex-col items-center">
        <h1 className="text-4xl font-bold mb-8">Semester 7 IT-BI - Previous Year Papers</h1>
...
export default Sem7_itbi_PreviousYearPaper;
