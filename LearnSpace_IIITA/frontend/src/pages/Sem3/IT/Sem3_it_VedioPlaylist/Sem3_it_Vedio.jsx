...
const Sem3_it_VedioPlaylist = () => {
  return (
    <div className="fixed inset-0 bg-black text-white overflow-auto">
      {/* Custom Header */}
      <div className="pt-24 pb-8 max-w-screen-xl mx-auto px-4 flex flex-col items-center">
        <h1 className="text-4xl font-bold mb-8">Semester 3 IT - Subject Playlists</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          >
            ...
            />
            <h2 className="text-xl font-bold text-center px-2">Object Oriented Methodologies (OOM)</h2>
          </Link>
          ...
          >
            <img
              ...
              className="w-16 h-16 mb-4 animate-bounce"
            />
            <h2 className="text-xl font-bold text-center px-2">Operating System (OS)</h2>
          </Link>
          ...
          >
            <img
              ...
              className="w-16 h-16 mb-4 animate-bounce"
            />
            <h2 className="text-xl font-bold text-center px-2">Intorduction to Finanance</h2>
          </Link>
        </div>
      </div>
    </div>
...
export default Sem3_it_VedioPlaylist;
